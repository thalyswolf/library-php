...
class appProdProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => '', 'dbname' => 'prestashop13', 'user' => 'root', 'password' => '', 'charset' => 'UTF8', 'driverOptions' => array(1002 => 'SET sql_mode=(SELECT REPLACE(@@sql_mode,\'ONLY_FULL_GROUP_BY\',\'\'))'), 'serverVersion' => 5.0999999999999996), new \Doctrine\DBAL\Configuration(), $a, array('enum' => 'string'));
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_e3d3468eed335b659675f185d3ad700db0520bfa41ba150b7e31d3b1b275b6fd');
    ...
    {
        return $this->services['locale_listener'] = new \Symfony\Component\HttpKernel\EventListener\LocaleListener($this->get('request_stack'), 'pt-PT', $this->get('router', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('jqnWKNFzI8n8LqftNfkLfMaTvCsfefyyy6ekz1W1VRfTDbyB0zjIEDRW');
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('59c6ae8b976030.92965652')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'secret' => 'jqnWKNFzI8n8LqftNfkLfMaTvCsfefyyy6ekz1W1VRfTDbyB0zjIEDRW',
            'ps_caching' => 'CacheMemcache',
            'ps_cache_enable' => false,
            'ps_creation_date' => '2017-09-23',
            'locale' => 'pt-PT',
            'cookie_key' => '7fXrSbegLUWVK11iOfNd1k4Rdx3o24m4csPzJyVmsL2Ay4R83pSPAC5k',
            'cookie_iv' => 'Yiv5tJ5L',
            'new_cookie_key' => 'def0000085d4843b6bb210930d1b718c5e99389076c5d04b8006ddd0d701b7e21532fff74e7c4bf171f6d71dc53e2ed5f72b54fbd18ca503ed1112bc2c96d9e3acabe96c',
            ...
            'kernel.secret' => 'jqnWKNFzI8n8LqftNfkLfMaTvCsfefyyy6ekz1W1VRfTDbyB0zjIEDRW',
